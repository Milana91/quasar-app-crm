<template>
     <q-card-section class="q-pt-none">
        <div class="q-gutter-y-md column" style="max-width: 300px">
          <AppInput filled label="ФИО клиента" 
          :rules="[MyRule, val =>  !!val || 'Введите ФИО клиента']" 
          autofocus  
          :modelValue="name"
          ...
          <AppInput filled label="Email" type="text" autofocus
           ...
           <AppInput filled label="Телефон" type="tel" autofocus
           :modelValue="phone" 
           @update:modelValue="event => $emit('update:phone', event)" />
           <AppInput filled label="Компания" type="text" autofocus
           :modelValue="company" 
           @update:modelValue="event => $emit('update:company', event)" />
